...
extension ImageResource {
    ...
    static let nodata = ImageResource(name: "nodata", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "nodata" asset catalog image.
    static var nodata: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .nodata)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "nodata" asset catalog image.
    static var nodata: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .nodata)
#else
        .init()
